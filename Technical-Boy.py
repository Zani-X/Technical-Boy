...
##### LOGO #####
logo = """
_____ _____ ____ _   _ _   _ ___ ____    _    _       ____   _____   __
|_   _| ____/ ___| | | | \ | |_ _/ ___|  / \  | |     | __ ) / _ \ \ / /
  | | |  _|| |   | |_| |  \| || | |     / _ \ | |     |  _ \| | | \ V /
  | | | |__| |___|  _  | |\  || | |___ / ___ \| |___  | |_) | |_| || |
  |_| |_____\____|_| |_|_| \_|___\____/_/   \_\_____| |____/ \___/ |_|
...
print  """
 ...
 \033[1;96m           тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд  тХ▒тЦФтЦФтЦФтЦФтФКтФКтФКтФКтЦФтЦФтЦФтЦФтХ▓  тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд
  \033[1;96m          тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд
       \033[1;93m    тЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦТтЦТWelcome To  ZainтЦТтЦТтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИ
...
\033[1;94mWhatsapp  \033[1;91m: \033[1;91m+923423572404
...
jalan('\033[1;92m   :......................... Technical-boy.........................:')
jalan("\033[1;93m   тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд Welcome to Zain тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд   ")
jalan('\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ____Login New Acountт____ФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ  ')
jalan('\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИ____CP Acount Open After 7 Days___тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ  ')
jalan("\033[1;93m тШЮ тФИтФИFrends Cloning k liy sirf indian id ka link us├и karainтФИ ")
jalan("\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИтФИWhatsApp Num :  +923423572404тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ")
print "\033[1;95m   тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mLogin Zain\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
...
def login():
	...
	try:
		...
		jalan(' \033[1;92m     Notice:тШЮ \033[1;93mStay Home Stay Safe Save lives Save Pakistan' )
                jalan(' \033[1;92m     Notice:тШЮ \033[1;97m"Pray NAMAZ five time Daily' )
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mB4Baloch\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By Zain-hacker--тАвтЧИтАв---┬╗" #Dev:Zain_hacker
...
: \033[1;93m.Hacker  Zain.... \033[1;93m :
тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд.' 
